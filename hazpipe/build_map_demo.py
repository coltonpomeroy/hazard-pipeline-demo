...
<div id="app">
  ...
  <div id="map-wrap">
    ...
    <div class="console">
      ...
      <div>
        <div class="foot">
          <b>Synthetic demo data.</b> Pipeline: GRIB2 &rarr; xarray &rarr; Zarr &rarr;
          threshold &rarr; polygonize &rarr; GeoJSON. Click a zone for attributes.
...
<div id="about" class="about-overlay" hidden>
  <div class="about-card">
    ...
    <ol class="about-steps">
      <li><b>GRIB2 in.</b> A wind-gust forecast encoded as real GRIB2 (the WMO
      format NOAA models like HRRR and GFS ship in), read back with
      <span class="m">xarray</span> + <span class="m">cfgrib</span>.</li>
    ...
    <p class="about-note"><b>Honest scope:</b> this sandbox can't reach NOAA, so
    the forecast <i>values</i> are synthetic &mdash; but the formats, libraries,
    and the whole pipeline are the real ones. Going live means swapping one
    module for a NOMADS fetch; nothing downstream changes.</p>
  </div>
</div>
